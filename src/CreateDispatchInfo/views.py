...
from .models import DispatchInfoCreate,DispatchListRequest
...
@router.post("/create_dispatch_info")
def create_dispatch_details(
    dispatch_create: DispatchInfoCreate,
...
@router.post("/dispatch_info_list")
