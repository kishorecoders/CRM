...
class QuotationSubProductEmployeeBase(SQLModel):
    ...
    sub_product_name : Optional[str]= Field(nullable=False,default=None)
    quantity : Optional[str]= Field(nullable=False,default=None)

    add_remark : Optional[str]= Field(nullable=True,default=None)

class QuotationSubProductEmployee(QuotationSubProductEmployeeBase,table = True):
    __tablename__ = "quotation_sub_product_employee"
...
class QuotationSubProductQuantity(BaseModel):
    subproduct_id: int
    quantity: str