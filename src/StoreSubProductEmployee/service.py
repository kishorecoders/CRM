...
from src.QuotationSubProductEmployee.models import QuotationSubProductEmployeeCreate ,QuotationSubProductEmployee ,QuotationSubProductEmployeeRead , QuotationSubProductEmployeeDelete ,QuotationSubProductAddRemark
...
def create(db: Session, quotation_SubProductcreate: QuotationSubProductEmployeeCreate):
    ...
    for item in quotation_SubProductcreate.sub_products:
        ...
        db_subpro = QuotationSubProductEmployee(
            ...
            quantity=quantity,
            add_remark=quotation_SubProductcreate.add_remark
        )
        db.add(db_subpro)
        db.commit()
